...
public class TaskScheduler {
    ...
    // Alarm State Getters and Setters
    ...
    // Setter for currentStartTime (resets alarm state when starting)
    public void setCurrentStartTime(LocalDateTime currentStartTime) {
        this.currentStartTime = currentStartTime;
        if (currentStartTime != null) {
            this.alarmTriggered = false; // Reset alarm state when starting a new run
        }
    }
}